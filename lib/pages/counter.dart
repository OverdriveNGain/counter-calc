...
class _Count extends State<Count> {
  ...
  Widget build(BuildContext context) {
    if (denominationControllers == null) {
      denominationControllers = List.generate(Save.denominations.length, (n) {
        ...
        child: Column(
          ...
          children: [
            GestureDetector(
              onLongPress: () {
                Clipboard.setData(
                    ClipboardData(text: displayTotal(Save.denominations)));
